...
🔗 **[ResQGrid — Live Demo](https://sih-disaster-management-beige.vercel.app)**

Experience the **ResQGrid Tactical GIS Dashboard** with interactive hazard analysis, relocation planning, carrying-capacity assessment, and proactive disaster-management intelligence.
...
2. **Dual-Horizon Carrying Capacity Assessment:** Evaluates both temporary relief camps (minimum bottleneck of beds, drinking water 15L/day, food rations, and sanitation) AND safer permanent resettlement land parcels outside hazard zones.
...
**Vercel:**
https://sih-disaster-management-beige.vercel.app

### Backend

**Render:**
FastAPI-based cloud backend powering the ResQGrid decision-support engine.

---

**Team BharatBytes • Vignan's Foundation for Science, Technology & Research • SIH 2026**
